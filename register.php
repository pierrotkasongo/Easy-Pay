<?php
session_start(); 
$_SESSION['verif_page']=4;//numéro de page
?>
                ...
                <div class="row">
                    <div class="col col-login mx-auto">
                        <div class="text-center mb-6">
                            <img src="img/logo/logosn.png" class="h-6" alt="">
                        </div>
                        <form class="card" action="t_register.php" method="post">
